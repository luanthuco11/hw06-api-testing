# [BUG-FR01-004] Parser stack disclosure and wrong media status

## Summary

- Endpoint/area: Register
- Finding: Parser stack disclosure and wrong media status
...
2. Use the FR-01 clean registration fixture and collection folder.
3. Run the matching Postman folder with Newman.
4. Compare the failed test IDs, expected result, actual result, and impact in [the execution report](../../test-cases/fr01-register/execution-results.md).

## Evidence

- Newman HTML reports: [reports/newman](../../reports/newman)
- Detailed defect section: [test-cases/fr01-register/execution-results.md](../../test-cases/fr01-register/execution-results.md)
