# [BUG-FR14DELETE-001] ID coercion and affected-row checks allow false/unintended deletion

## Summary

- Endpoint/area: Category DELETE
- Finding: ID coercion and affected-row checks allow false/unintended deletion
