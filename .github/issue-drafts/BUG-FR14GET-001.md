# [BUG-FR14GET-001] Unacceptable HTML media is ignored

## Summary

- Endpoint/area: Category GET
- Finding: Unacceptable HTML media is ignored
...
2. Start the SUT, prepare the fixture mode named in the GET execution report, then run its folder.
3. Run the matching Postman folder with Newman.
4. Compare the failed test IDs, expected result, actual result, and impact in [the execution report](../../test-cases/fr14-get-categories/execution-results.md).

## Evidence

- Newman HTML reports: [reports/newman](../../reports/newman)
- Detailed defect section: [test-cases/fr14-get-categories/execution-results.md](../../test-cases/fr14-get-categories/execution-results.md)
